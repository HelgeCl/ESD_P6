...
def receive(usrp, num_samples=1000):
    ...
    return sig_ch1.deepcopy(), sig_ch2.deepcopy()
...
def plot(sig_ch1, sig_ch2, name):
    ...
    plt.savefig('plot_'+str(name)+'.png', dpi=300, bbox_inches='tight')


RX_data = receive(usrp, 100000)

# phase_offset = 46.620819065443165-cal_phase(ch1, ch2)-52.022846445
...
RX_TX_data = receive(usrp, 100000)

"""phase_corr = phase_offset
...
"""
# All test done with -17dBm

np.savez_compressed('usrp_data_from_degree_XX.npz',
                    RX0=RX_data[0], RX1=RX_data[1], RX_TX0=RX_TX_data[0], RX_TX1=RX_TX_data[1])
